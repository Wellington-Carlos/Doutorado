...
%%  \usepackage[brazilian]{babel}      %% in ThesisPUC.cls
  ...
  \usepackage{textcomp}
  \usepackage{float}
\usepackage{enumitem} % adiciona no preâmbulo
% \usepackage{etoolbox}
...
\begin{document}
\listofalgorithms  % <---- Adicione esta linha aqui
 % \input{introduction}
  \input{chapter-1}
  \input{chapter-2}  % Fundamentação teórica
  \input{chapter-3}  % Aplicação de ML e AI na indústria de óleo e gás
  \input{chapter-4}  % Estado da arte
  \input{chapter-5}  % Resultados preliminares
  \input{chapter-6}  % Próximos passos
  \input{conclusions}
  %% ...
  \arial
