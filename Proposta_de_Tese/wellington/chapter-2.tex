...
\begin{figure} [H]
  \begin{center}
    ...
    \caption{Taxas de produção de óleo e água para os quatro poços produtores.}\label{fig:2.20}
  \end{center}
\end{figure}
