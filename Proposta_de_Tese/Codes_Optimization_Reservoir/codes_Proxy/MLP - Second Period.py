...
if os.path.exists("TrainedMLP - First Second.hdf5"):
...
fig.tight_layout()
fig.savefig("Loss - Period 2.jpg", dpi=300, format="jpg")
...
fig.tight_layout()
plt.show()
fig.savefig("Crossplot Test - Period 2.jpg", dpi=300, format="jpg")
